<%-- WebContent/admin/edit-user.jsp --%>
...
<body>
    ...
    <main class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0"><i class="fas fa-user-edit me-2 text-warning"></i>Chỉnh sửa người dùng</h1>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <c:if test="${not empty user}">
                    <form method="post" action="${pageContext.request.contextPath}/admin/edit-user.jsp">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="roleCode" class="form-select">
                                    <option value="USER" ${user.roleCode == 'USER' ? 'selected' : ''}>Người dùng</option>
                                    <option value="ADMIN" ${user.roleCode == 'ADMIN' ? 'selected' : ''}>Quản trị viên</option>
                                </select>
                            </div>
                            <div class="col-md-6">
