<%-- admin/categories.jsp (list with search, similar to products) --%>
...
<body>
    ...
    <main class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <span class="badge bg-success fs-6">Tổng: ${totalCount} danh mục</span>
        </div>

        <!-- Search form -->
        <div class="card mb-4">
            <div class="card-body">
                <form method="get" action="${pageContext.request.contextPath}/admin/search-category.jsp">
                    <div class="row">
                        <div class="col-md-6">
                            <input type="text" class="form-control" name="keyword" placeholder="Tìm theo tên, code..." value="${keyword}">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/add-category.jsp" class="btn btn-success"><i class="fas fa-plus me-1"></i>Thêm mới</a>
                        </div>
                    </div>
                </form>
            </div>
                        ...
                        <tbody>
                            <c:forEach var="category" items="${categories}">
                                <tr>
                                    ...
                                    <td>${category.parentId != null ? category.parentName : 'Cấp cha'}</td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/admin/edit-category.jsp?id=${category.id}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
                                        <form method="post" action="${pageContext.request.contextPath}/admin/delete-category.jsp" style="display:inline;">
                                            <input type="hidden" name="id" value="${category.id}">
                                            <button class="btn btn-sm btn-danger" onclick="return confirm('Xóa danh mục này?')"><i class="fas fa-trash"></i></button>
                                        </form>
                                    </td>
                                </tr>
                            </c:forEach>
