<%-- admin/edit-category.jsp (edit form) --%>
...
<head>
    ...
    <style>
        ...
        .card-header { background-color: #ffc107; color: #000; }
    </style>
</head>
<body>
    ...
    <main class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0"><i class="fas fa-edit me-2 text-warning"></i>Cập nhật Danh mục</h1>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Cập nhật: ${category.name}</h5>
            </div>
            <div class="card-body">
                ...
                <form method="post" action="${pageContext.request.contextPath}/admin/editCategory">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button class="btn btn-warning"><i class="fas fa-save me-2"></i>Cập nhật danh mục</button>
                    </div>
                </form>
            </div>
        </div>
