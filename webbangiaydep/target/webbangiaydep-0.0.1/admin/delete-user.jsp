<%-- WebContent/admin/delete-user.jsp --%>
...
<body>
    ...
    <main class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0"><i class="fas fa-user-times me-2 text-danger"></i>Xác nhận xóa người dùng</h1>
            ...
            <div class="card-body">
                ...
                <c:if test="${not empty user}">
                    <div class="alert alert-warning">
                        ...
                        Bạn có chắc chắn muốn <strong>xóa người dùng này</strong>? Hành động này <strong>không thể hoàn tác</strong>.
                    </div>
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/admin/delete-user.jsp" onsubmit="return confirm('Xác nhận xóa?')">
                        <input type="hidden" name="id" value="${user.id}">
                        <div class="d-flex justify-content-end gap-2">
                            <a href="${pageContext.request.contextPath}/admin/users.jsp" class="btn btn-secondary"><i class="fas fa-ban"></i> Hủy</a>
                            <button type="submit" class="btn btn-danger"><i class="fas fa-trash"></i> Xóa vĩnh viễn</button>
                        </div>
                    </form>
                </c:if>
            </div>
